...
(fact "uniform selection returns a vector of answers"
  ...
  (type (first (uniform-selection fixtures/some-guys fixtures/some-scores))) =>
    answer_factory.answer.push.PushAnswer)


(fact "uniform selection returns one item sampled at random"
  (count (uniform-selection fixtures/some-guys fixtures/some-scores)) => 1
  fixtures/some-guys => (contains (uniform-selection fixtures/some-guys fixtures/some-scores)))
